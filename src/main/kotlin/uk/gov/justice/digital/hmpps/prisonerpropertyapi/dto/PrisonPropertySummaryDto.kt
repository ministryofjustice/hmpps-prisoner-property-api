...
data class PrisonPropertySummaryDto(
  ...
  @Schema(description = "Number of containers due to be returned: those flagged after the prisoner's release, plus stored containers whose owner has a confirmed release date within a day", example = "36")
